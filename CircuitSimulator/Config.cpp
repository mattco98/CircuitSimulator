...
sf::Vector2f PANEL_INSTRUCT_3 = { float(GRID_LEFT_OFFSET - GUI_X_PADDING), float(SCREEN_HEIGHT - GUI_Y_PADDING - 250) };
sf::Vector2f PANEL_INSTRUCT_4 = { float(GUI_X_PADDING), float(SCREEN_HEIGHT - GUI_Y_PADDING - 250) };
sf::Vector2f PANEL_INFO_1 = { float(GUI_X_PADDING), float(SCREEN_HEIGHT - GUI_Y_PADDING - 220) };
sf::Vector2f PANEL_INFO_2 = { float(GRID_LEFT_OFFSET - GUI_X_PADDING), float(SCREEN_HEIGHT - GUI_Y_PADDING - 220) };
...
void set(int width, int height) {
    ...
    PANEL_INSTRUCT_3 = { float(GRID_LEFT_OFFSET - GUI_X_PADDING), float(SCREEN_HEIGHT - GUI_Y_PADDING - 250) };
    PANEL_INSTRUCT_4 = { float(GUI_X_PADDING), float(SCREEN_HEIGHT - GUI_Y_PADDING - 250) };
    PANEL_INFO_1 = { float(GUI_X_PADDING), float(SCREEN_HEIGHT - GUI_Y_PADDING - 220) };
    PANEL_INFO_2 = { float(GRID_LEFT_OFFSET - GUI_X_PADDING), float(SCREEN_HEIGHT - GUI_Y_PADDING - 220) };
